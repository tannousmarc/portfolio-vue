  ...
  <div id = "projects">
    <div class = "homepage-project" v-for = "project in projects" :key = "project.id" v-bind:style = "{ backgroundImage: 'url(' + project.cover + ')' }">
      <div class = "text-container">
        ...
        <BaseButton class = "mobile" :url = "project.studyUrl" text = "Case Study" />
        <BaseButton v-if = "project.url" class = "mobile" :url = "project.url" text = "Check it out" />
      </div>
    </div>
  </div>
</template>
    ...
    return {
      projects: [
        ...
        },
        {
          ...
          url: 'https://www.alces.ca/software/',
...
@media only screen and (max-width: 780px){
  .homepage-project .text-container pre{
    width: 100%;
